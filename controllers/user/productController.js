...
const displayStore = async (req, res) => {
    ...
    if (priceTo) matchStage.$match.price = { ...matchStage.$match.price, $lte: parseFloat(priceTo) }; // check this line 
    ...
    //   console.log(pipeline) // testing
      ...
      const totalPages = Math.ceil(totalCount / limit);
       // collect the categories and brands
...
export {displayProductUser, displayUserHome, displayAllProducts, displayStore}
